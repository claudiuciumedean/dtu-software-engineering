...
namespace LiRACore.Models.RawData.List
{
    using System;
    ...
    public partial class AutoPiSensorList
    {
        [JsonProperty("@vid")]
    ...
    public partial class AutoPiSensorList
    {
        public static List<AutoPiSensorList> FromJson(string json) => JsonConvert.DeserializeObject<List<AutoPiSensorList>>(json, Helpers.Converter.Settings);
    }

    //public static class Serialize
    //{
    //    public static string ToJson(this List<AutoPiSensorList> self) => JsonConvert.SerializeObject(self, LiRACore.Models.RawData.Converter.Settings);
    //}
